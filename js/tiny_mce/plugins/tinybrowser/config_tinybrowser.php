...
/*
 * bu plugin sadece panel kullanıcıları tarafından kullanılacağı için
 * oturum açmamış kişilerde çalışmamalıdır. bu yüzden oturum açık değilse
 * betiğin çalışması durduruluyor.
 * */
session_start();
$tinybrowser['sessioncheck'] = 'tinymceprivilege'; //name of session variable to check
...
$tinybrowser['path']['image'] = '/content/img/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/content/tinymceBrowser/media/'; // Media files location
$tinybrowser['path']['file']  = '/content/tinymceBrowser/files/'; // Other files location
